...
SKOPE_REJECTS_FILE="/home/sriharipriya/BatchJobsDemo/SkopeAlertUploader/SkopeAlertUploader/script/skope_rejects.txt"
# Set the email address to receive alerts
ALERT_EMAIL="xyz@email.com"
# Set the threshold for the number of rejects to trigger an alert
REJECTS_THRESHOLD=50
